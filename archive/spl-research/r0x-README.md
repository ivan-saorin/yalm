...
If ALL fail: the integration thesis is wrong. YALM and SPL are better kept separate. Still valuable knowledge.
...
### Rust (for r0x-003)
Extends existing YALM crates or new `yalm-spl` crate.

### Ollama (for r0x-004, r0x-005)
Already configured for YALM open-mode. Uses qwen3 model.
